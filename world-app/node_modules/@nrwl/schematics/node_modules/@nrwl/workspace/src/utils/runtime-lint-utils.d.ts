import { ProjectGraphNode, ProjectGraphDependency, ProjectGraph } from '../core/project-graph';
...
export declare function findProjectUsingImport(projectGraph: ProjectGraph, npmScope: string, imp: string): ProjectGraphNode<{}>;
export declare function isCircular(graph: ProjectGraph, sourceProject: ProjectGraphNode, targetProject: ProjectGraphNode): boolean;
